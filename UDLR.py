...
while True:
    ...
    if results.multi_hand_landmarks != None:
          ...
          #If Two Finger Open --> up
          if count_fingers_open == 5:
                cv.rectangle(image, (20, 300), (270, 425), (0, 255, 0), cv.FILLED)
                cv.putText(image, "UP", (45, 375), cv.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 5)

                keyboard.press(Key.up)
                keyboard.release(Key.down)
                keyboard.release(Key.left)
                keyboard.release(Key.right)
          # If All Fingers Closed --> down
          elif count_fingers_open == 0:
                cv.rectangle(image, (20, 300), (270, 425), (0, 255, 0), cv.FILLED)
                cv.putText(image, "DOWN", (45, 375), cv.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 5)

                keyboard.press(Key.down)
                keyboard.release(Key.up)
                keyboard.release(Key.right)
                keyboard.release(Key.left)
          #If Two Finger Open -->left
          elif count_fingers_open == 2:
                cv.rectangle(image, (20, 300), (270, 425), (0, 255, 0), cv.FILLED)
                cv.putText(image, "LFFT", (45, 375), cv.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 5)

                keyboard.press(Key.left)
                keyboard.release(Key.down)
                keyboard.release(Key.up)
                keyboard.release(Key.right)
          # If One Finger Open --> right
          elif count_fingers_open == 1:
                cv.rectangle(image, (20, 300), (270, 425), (0, 255, 0), cv.FILLED)
    ...
    # Show the Video
    cv.imshow("Shamal's Hand Controller", image)
